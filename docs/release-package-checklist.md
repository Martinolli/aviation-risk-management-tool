...
| REL-VAL-008 | Validation Evidence | Release version metadata added | Not Started | Backend readiness and frontend footer |  |  |
...
| REL-TAG-005 | Release Tagging | Release tag pending final review | Not Started | `v1.0.0-pilot` tag not created until review approval |  |  |
